...
├── cookiecutter_click_project             # The main python package for the project
...
e.g: `cat cookiecutter_click_project/VERSION` will get the project version without harming
